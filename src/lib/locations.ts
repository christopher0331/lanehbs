...
export const serviceAreaCities: ServiceAreaCity[] = [
  ...
  },
  {
    ...
    heroDescription:
      "Plateau-ready painting, remodeling, decks, and fences for Enumclaw homes and businesses — including Downtown, Elk Meadows, Boise Creek, the Enumclaw Plateau, and Osceola along the heritage-loop farm roads south of town. Licensed local craftsmanship. Free estimates at (253) 414-3937.",
    ...
    faqs: [
      {
        ...
        answer:
          "We work Downtown Enumclaw, Elk Meadows on Riggs Drive E and Bondgard Avenue E, Boise Creek, the Enumclaw Plateau, and Osceola along SE 448th Street, SE 456th Way, 196th Avenue SE, and 220th Avenue SE — plus nearby King County parcels.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Elk Meadows on Riggs Drive E and Bondgard Avenue E, downtown Enumclaw, Boise Creek, plateau homes, and nearby King County streets are all in our regular Enumclaw coverage.",
      },
      {
  ...
  },
  {
    ...
    heroDescription:
      "Maple Valley painting, remodeling, decks, and fences with clean job sites and lasting finishes. Serving Wilderness Rim, Summit, Tahoma, Four Corners, Lake Wilderness, Lake Desire, Meadows at Rock Creek, Hobart, Shadow Lake, Cedar Downs & more. (253) 414-3937.",
    ...
    faqs: [
      {
        ...
        answer:
          "We work across Maple Valley including Wilderness Rim, Summit, Tahoma along SE Tahoma Way, Four Corners, Lake Wilderness communities, Lake Desire (Maple Heights–Lake Desire), Meadows at Rock Creek along SE 268th Street, nearby Hobart along Issaquah-Hobart Road, Shadow Lake along Petrovitsky and Sweeney Road, Cedar Downs off Witte Road SE, and Ravensdale.",
      },
      {
