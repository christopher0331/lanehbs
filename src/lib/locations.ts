...
export const serviceAreaCities: ServiceAreaCity[] = [
  ...
  },
  {
    ...
    heroDescription:
      "Maple Valley painting, remodeling, decks, and fences with clean job sites and lasting finishes. Serving Wilderness Rim, Summit, Tahoma, Four Corners, Lake Wilderness, Lake Desire, Lake Francis, Meadows at Rock Creek, Hobart, Shadow Lake, Cedar Downs & more. (253) 414-3937.",
    ...
    faqs: [
      {
        ...
        answer:
          "We work across Maple Valley including Wilderness Rim, Summit, Tahoma along SE Tahoma Way, Four Corners, Lake Wilderness communities, Lake Desire (Maple Heights–Lake Desire), Lake Francis along SE Lake Francis Road, Meadows at Rock Creek along SE 268th Street, nearby Hobart along Issaquah-Hobart Road, Shadow Lake along Petrovitsky and Sweeney Road, Cedar Downs off Witte Road SE, and Ravensdale.",
      },
      {
    ...
    articleSections: [
      {
        ...
        body: "From Wilderness Rim slopes to Summit streetscapes, Tahoma along SE Tahoma Way, Four Corners along SR 169 and Kent-Kangley, Meadows at Rock Creek on the SE 268th HOA streets, Lake Desire’s unincorporated two-lake pocket north of town, Lake Francis’s private kettle lake on SE Lake Francis Road, unincorporated Hobart along Issaquah-Hobart Road, Shadow Lake along Petrovitsky and Sweeney Road, and Cedar Downs’ 1976 HOA lots off Witte Road SE, Lane HBS helps Maple Valley homeowners protect and upgrade their properties. Interior painting, exteriors, cabinets, decks, and fences — scoped clearly and finished carefully.",
      },
      {
