...
export const serviceAreaCities: ServiceAreaCity[] = [
  ...
  },
  {
    ...
    heroDescription:
      "Maple Valley painting, remodeling, decks, and fences with clean job sites and lasting finishes. Serving Wilderness Rim, Summit, Tahoma, Four Corners, Lake Wilderness, Lake Desire, Meadows at Rock Creek, Hobart, Shadow Lake, Cedar Downs, Maple Ridge Highlands & more. (253) 414-3937.",
    ...
    faqs: [
      {
        ...
        answer:
          "We work across Maple Valley including Wilderness Rim, Summit, Tahoma along SE Tahoma Way, Four Corners, Lake Wilderness communities, Lake Desire (Maple Heights–Lake Desire), Meadows at Rock Creek along SE 268th Street, nearby Hobart along Issaquah-Hobart Road, Shadow Lake along Petrovitsky and Sweeney Road, Cedar Downs off Witte Road SE, Maple Ridge Highlands and Maple Woods on SE Maple Ridge Drive, and Ravensdale.",
      },
      {
