...
export const serviceAreaCities: ServiceAreaCity[] = [
  {
    ...
    heroDescription:
      "Local Lake Tapps contractor for interior & exterior painting, cabinet refinishing, decks, fences, and home renovations — including Tapps Island, Deer Island, Snag Island, Driftwood Point, West Tapps, Allan Yorke, Tacoma Point, North Lake Tapps around the county park, and the plateau. Free estimates. Call (253) 414-3937.",
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. We work Tapps Island, Deer Island, Snag Island, Driftwood Point, West Tapps, Allan Yorke around the south-end city park, Tacoma Point and Evergreen Point on the northwest peninsulas, North Lake Tapps along 198th Ave E and 9th St E by the county park, the Lake Tapps Plateau, Bonney Lake, and nearby Pierce County communities including Sumner, Auburn, and Edgewood.",
      },
      {
