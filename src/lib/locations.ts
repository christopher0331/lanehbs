...
export const serviceAreaCities: ServiceAreaCity[] = [
  {
    ...
    heroDescription:
      "Local Lake Tapps contractor for interior & exterior painting, cabinet refinishing, decks, fences, and home renovations — including Tapps Island, Snag Island, Driftwood Point, West Tapps, and the plateau. Free estimates. Call (253) 414-3937.",
    ...
    faqs: [
      {
        question: "Do you serve Tapps Island and the rest of Lake Tapps?",
        answer:
          "Yes. We work Tapps Island, Snag Island, Driftwood Point, West Tapps, the Lake Tapps Plateau, Bonney Lake, and nearby Pierce County communities including Sumner, Auburn, and Edgewood.",
      },
      {
    ...
    articleSections: [
      {
        ...
        body: "Lane Home & Business Services LLC is rooted in Lake Tapps. That means we understand reservoir humidity, elevated decks, and the finish quality neighbors notice on lakeside streets — from gated Tapps Island off Island Parkway East to Snag Island, Driftwood Point, West Tapps, and the plateau. Whether you need a full exterior repaint, a kitchen cabinet refresh, or a deck rebuild, you get licensed, insured craftsmanship with clear communication.",
      },
      {
