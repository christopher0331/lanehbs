...
export const serviceAreaCities: ServiceAreaCity[] = [
  ...
  },
  {
    ...
    heroDescription:
      "Maple Valley painting, remodeling, decks, and fences with clean job sites and lasting finishes. Serving Wilderness Rim, Summit, Four Corners, Lake Wilderness, Shadow Lake & more. (253) 414-3937.",
    ...
    faqs: [
      {
        ...
        answer:
          "We work across Maple Valley including Wilderness Rim, Summit, Four Corners, Lake Wilderness communities, Shadow Lake along Petrovitsky and Sweeney Road, Tahoma-area streets, and nearby Ravensdale.",
      },
      {
    ...
    articleSections: [
      {
        ...
        body: "From Wilderness Rim slopes to Summit streetscapes, Four Corners along SR 169 and Kent-Kangley, and Shadow Lake along Petrovitsky and Sweeney Road, Lane HBS helps Maple Valley homeowners protect and upgrade their properties. Interior painting, exteriors, cabinets, decks, and fences — scoped clearly and finished carefully.",
      },
      {
