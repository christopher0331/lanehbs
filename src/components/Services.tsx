...
function ServiceCard({
  ...
  return (
    <Link
      ...
      className="group relative bg-[#0d0d0d] border border-white/10 p-8 hover:border-[#c9a458]/40 transition-all duration-500 block"
    >
      ...
      <div className="mt-6 flex items-center gap-2 text-[#c9a458] text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <span className="text-xs tracking-widest uppercase">View Service Page</span>
        <span>→</span>
      </div>
    </Link>
  );
